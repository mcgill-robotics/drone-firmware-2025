...
uint32_t MCP2517Settings::sysClock (const Oscillator inOscillator) {
...
MCP2517Settings::MCP2517Settings (const Oscillator inOscillator,
...
uint32_t MCP2517Settings::actualBitRate (void) const {
...
bool MCP2517Settings::exactBitRate (void) const {
  const uint32_t TQCount = 1 /* Sync Seg */ + mPhaseSegment1 + mPhaseSegment2 ;
...
uint32_t MCP2517Settings::ppmFromDesiredBitRate (void) const {
  const uint32_t TQCount = 1 /* Sync Seg */ + mPhaseSegment1 + mPhaseSegment2 ;
...
uint32_t MCP2517Settings::samplePointFromBitStart (void) const {
  const uint32_t TQCount = 1 /* Sync Seg */ + mPhaseSegment1 + mPhaseSegment2 ;
...
uint32_t MCP2517Settings::CANBitSettingConsistency (void) const {
...
uint32_t MCP2517Settings::ramUsage (void) const {
  uint32_t result = 0 ;
//--- TXQ
