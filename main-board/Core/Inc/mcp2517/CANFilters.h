...
#ifndef INC_MCP2517_CANFILTERS_H_
#define INC_MCP2517_CANFILTERS_H_
...
class CANFilters {
  ...
  private: CANFilters (const CANFilters &) = delete ;
  private: CANFilters & operator = (const CANFilters &) = delete ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  // Friend
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  friend class CAN2517 ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

} ;

#endif /* INC_MCP2517_CANFILTERS_H_ */
