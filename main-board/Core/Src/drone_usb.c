...
//#include "stm32f4xx_hal_tim.h"            // for PWM outputs
#include <string.h>
...
void USB_SendTelemetry(uint16_t current_mA,
                       ...
                       uint16_t temp2_dC)
{
    uint8_t msg[5 + 10]; // header+id+len + payload(10) + crc
    ...
    msg[8] = soc_pct & 0xFF;
    msg[9] = soc_pct >> 8;
    msg[10] = temp1_dC & 0xFF;
    msg[11]= temp1_dC >> 8;
    msg[12]= temp2_dC & 0xFF;
    msg[13]= temp2_dC >> 8;
    msg[14]= crc8(&msg[2], 2+10);
