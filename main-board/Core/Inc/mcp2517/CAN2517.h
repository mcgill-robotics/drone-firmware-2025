...
class CAN2517 {
  ...
  public: CAN2517 (SPI_HandleTypeDef* hspi, // Hardware SPI object
		  GPIO_TypeDef* csPort,
		  uint16_t csPin,
		  GPIO_TypeDef* intPort = nullptr,
		  uint16_t intPin = 0
...
//  private: SPIClass & mSPI ;
  private: SPI_HandleTypeDef* m_hspi;
//  private: uint8_t mCS ;
//  private: uint8_t mINT ;
  private: GPIO_TypeDef* m_csPort;
  private: uint16_t m_csPin;
  private: GPIO_TypeDef* m_intPort;
  private: uint16_t m_intPin;
